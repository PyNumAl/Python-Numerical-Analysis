...
class RK:
    ...
    is used. Otherwise, for methods of order >=5  e.g. RK5, RK5(4), and RK6(5), a quintic hermite spline is used so that
    the interpolation error is of the same order of the method.
    The quintic hermite spline is generated using scipy.interpolate.BPoly.from_derivatives (https://docs.scipy.org/doc/scipy/reference/generated/scipy.interpolate.BPoly.from_derivatives.html#scipy.interpolate.BPoly.from_derivatives)
